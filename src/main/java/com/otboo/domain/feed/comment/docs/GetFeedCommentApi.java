package com.otboo.domain.feed.comment.docs;
...
@ApiResponses({
    @ApiResponse(
        ...
        content = @Content(schema = @Schema(implementation = FeedCommentDtoCursorResponse.class))
    ),
    @ApiResponse(
        responseCode = "400",
...
public @interface GetFeedCommentApi {
}