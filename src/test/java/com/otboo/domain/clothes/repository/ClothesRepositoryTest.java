...
public class ClothesRepositoryTest {
    ...
    void 의상을_저장하면_조회할_수_있다() {
        ...
        Clothes clothes = new Clothes(owner, "반팔 티셔츠", null, "TOP");
    ...
    void findByOwnerIdAndDeletedAtIsNull은_논리_삭제된_의상을_제외한다() {
        ...
        Clothes active = clothesRepository.save(new Clothes(owner, "코트", null, "OUTER"));
        Clothes deleted = clothesRepository.save(new Clothes(owner, "패딩", null, "OUTER"));
        deleted.delete();
